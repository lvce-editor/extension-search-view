...
test('should return formatted info text without an empty marketplace link', () => {
...
test('should maintain correct order of fields', () => {
  ...
  expect(result).not.toContain('Marketplace Link:')
  ...
  expect(lines.at(-1)).toBe('Publisher: Publisher A')
})
