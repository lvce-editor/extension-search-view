...
import * as DiffTitle from '../DiffTitle/DiffTitle.ts'
import * as DiffType from '../DiffType/DiffType.ts'

export const modules = [DiffItems.isEqual, DiffFocus.isEqual, DiffSearchValue.isEqual, DiffFocus.isEqual, DiffCss.isEqual, DiffTitle.isEqual]
